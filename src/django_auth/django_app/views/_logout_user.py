...
from django_auth.django_app.outputs import LogoutUserOutput
from django_auth.django_app.serializers import (
    LogoutUserSerializer,
)


class LogoutUserView(APIView):  # type: ignore[misc]
